...
In the TUI, you can review all your databases in a single place. [Check out the page for the TUI](/docs/tui)

</Callout>

## Writing data

The bamboost [SimulationWriter](/apidocs/simulation_writer#SimulationWriter) is used to write data during your simulation (or as part of a
...
[MutableGroup](/apidocs/common/hdf_pointer#MutableGroup).
